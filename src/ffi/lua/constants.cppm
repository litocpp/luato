...
export {
  ...
  inline constexpr auto LUA_VERSION_RELEASE_N =
      luato_lua_ffi::version_release_n;
  inline constexpr auto LUA_VERSION_NUM = luato_lua_ffi::version_num;
  inline constexpr auto LUA_VERSION_RELEASE_NUM =
      luato_lua_ffi::version_release_num;
  ...
  inline constexpr auto LUA_RIDX_MAINTHREAD =
      luato_lua_ffi::registry_main_thread;
